...
const PORTFOLIO_ITEMS = [
    ...
    },
    {
        ...
        tags: [
            { label: "Targeting", href: "#" },
            { label: "Data Strategy", href: "#" },
            { label: "Campaign Planning", href: "#" },
        ],
    },
    {
        classList: "mb-55",
        ...
        tags: [
            { label: "AI Creatives", href: "#" },
            { label: "Ad Design", href: "#" },
                    ...
                    <div className="col-xxl-4 col-lg-4">
                        <div className="mg-portfolio-title-wrap mg-portfolio-pin mb-30">
                            ...
                            <h2 className="alt-section-title lh-1 mb-30 reveal-text">
                                <RevealText>
                                     AI campaigns that drive growth
                                </RevealText>
                            </h2>
                            <div className="at_fade_anim" data-delay=".3">
                                <p className="mg-portfolio-dec mb-50">
                                    A selected showcase of ADS AI campaigns where artificial intelligence, creative strategy, and data insights come together to generate leads, engagement, and measurable business growth.
                                </p>
                            </div>
