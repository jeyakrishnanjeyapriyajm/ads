                    ...
                    <div className="row pt-250 align-items-end">
                        ...
                        <div className="col-lg-4 col-md-6 ms-auto text-end">
                            <span className="common-white fz-font-lg">
                                [ ADS AI creates smart advertising campaigns using artificial intelligence, data insights, and creative strategy to help brands generate leads, improve visibility, and grow faster. ]
                            </span>
                        </div>
                    </div>
                </div>
