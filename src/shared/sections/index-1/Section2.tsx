...
const AVATARS = [
    { src: "/assets/imgs/template/avatar/avatar-1.webp", alt: "", zClass: "z-2" },
    { src: "/assets/imgs/template/avatar/avatar-2.webp", alt: "", zClass: "z-3" },
    { src: "/assets/imgs/template/avatar/avatar-3.webp", alt: "", zClass: "z-4" },
    { src: "/assets/imgs/template/avatar/avatar-4.webp", alt: "", zClass: "z-5" },
    { src: "/assets/imgs/template/avatar/avatar-5.webp", alt: "", zClass: "z-5" },
] as const;
                    ...
                    <div className="col-xxl-11">
                        <div className="at-about-title-wrap mb-30">
                            ...
                            <h3 className="at-section-title mb-0">
                                <span className="">
                                    We create AI-powered advertising campaigns that help brands reach the right audience, generate quality leads, and grow faster with data-driven strategy.
                                </span>
                        ...
                        <div className="col-xxl-2 col-lg-3 col-md-7 mb-md-5">
                            <div className="at-about-subtitle-wrap mb-30">
                                <span className="at-about-subtitle">
                                    ...
                                    We build <span className="fw-700">smart advertising systems</span>, designed to increase visibility, engagement, and conversions.
                                </span>
                            </div>
                                        ...
                                        <div className="at-about-item anim-zoomin-wrap mb-40">
                                            <div className="mb-35">
                                                <div className="at-about-thumb fix anim-zoomin">
                                                    <img
                                                        ...
                                                        src="/assets/imgs/pages/img1.jpg"
                                                        alt=""
                                                        width={600}
                                            ...
                                            <div className="at-about-content">
                                                ...
                                                <p className="at-about-dec at_fade_anim">
                                                    We combine artificial intelligence, creative strategy, and data insights to build advertising campaigns that attract customers, generate leads, and grow brands faster.
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="col-lg-6 col-md-6">
                                        <div className="at-about-item mb-40 d-flex flex-column gap-4">
                                            <div className="at-about-content order-2 order-md-1">
                                                <h3 className="at-about-title mb-10 at-char-animation">AI Strategy & Innovation</h3>
                                                <p className="at-about-dec at_fade_anim">
                                                    Using artificial intelligence, audience insights, creative content, and automation, we design campaigns that improve performance and deliver measurable business results.
                                                </p>
                                            </div>
                                            <div className="anim-zoomin-wrap order-1 order-md-2">
                                                <div className="at-about-thumb fix anim-zoomin">
                                                    <img
                                                        ...
                                                        data-fade-from="bottom"
                                                        data-ease="bounce"
                                                        src="/assets/imgs/pages/img2.jpg"
                                                        alt="adsai"
                                                        width={500}
                                                        height={450} loading="lazy" />
                                                </div>
