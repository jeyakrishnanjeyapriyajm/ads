                ...
                <div className="container p-relative">
                    <div className="p-absolute bottom-100 start-0 ms-5 mb-100 d-none d-lg-block">
                        ...
                        >
                            ...
                            <span className="position-absolute top-50 start-50 translate-middle d-flex flex-column align-items-center justify-content-center">
                                ...
                                <span className="mt-2">
                                    <span className="fw-700 text-white">Let&apos;s Grow</span>
                                </span>
                            </span>
                        </a>
                    </div>
                    <div className="row align-items-end">
                            ...
                            <div className="at-hero-video mb-30 at_fade_anim">
                                ...
                                >
                                    <span>
                                        ...
                                        <span className="text-2">Our AI Process</span>
                                    </span>
                                    <i>
                                        <ArrowIcon />
                                    </i>
                                ...
                                <ul>
                                    ...
                                    <li className="at_fade_anim">
                                        <span className="fz-font-md fw-500 text-white ">
                                            We help brands grow with AI-powered campaigns, smart targeting,
                                            creative content, and data-driven advertising strategies.
                                        </span>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div className="at-hero-content mb-30">
                                ...
                                <h2 className="at-hero-title text-white">
                                    <span
                                        ...
                                        data-fade-from="top"
                                    >
                                        SMARTER ADS,  <br /> POWERED BY, <br /> AI.
                                    </span>
                                </h2>
                                <div
                                ...
                                >
                                    ...
                                    >
                                        <span>
                                            <span className="text-1">View Our Campaigns</span>
                                            <span className="text-2">View Our Campaigns</span>
                                        </span>
                                        <i>
                                            <ArrowIcon />
                                        </i>
                        ...
                        <div className="col-1 ms-auto text-end align-self-start rotate-90 order-xl-2 order-md-1 d-none d-md-block">
                            <a href="mailto:business@adsai.ai" className="text-white fw-600">
                                <span className="at_fade_anim">business@adsai.ai</span>
                            </a>
                        </div>
                    </div>
