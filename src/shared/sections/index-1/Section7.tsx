...
export default function Section7() {
    return (
        <div className="container-2200">
            {/* at-sec7-area-start */}
            <section className="at-sec7-area pt-120 pb-120 bg-[#04151e] rounded-5 mx-lg-3 mx-2 mt-10">
                            ...
                            <div className="at-about-title-wrap mb-30">
                                <span className="at-btn common-black bg-transparent mb-10 rounded-0 p-0">
                                    <span className="text-uppercase">
                                        <span className="text-1">Why choose ADS AI</span>
                                        <span className="text-2">Why choose ADS AI</span>
                                    </span>
                                    <i>
                                        {ARROW_SVG}
                                        {ARROW_SVG}
                                ...
                                <h3 className="at-section-title reveal-text mb-80">
                                    <RevealText>
                                        Helping brands grow faster with AI-powered advertising, smart targeting, creative automation, and measurable campaign results.
                                    </RevealText>
                                </h3>
                            </div>
                        </div>
                                ...
                                <div className="at-image-hover p-relative rounded-4 overflow-hidden">
                                    ...
                                    <div className="content">
                                        <h6 className="common-white position-absolute bottom-0 start-0 m-4">
                                           Smart advertising starts with the right strategy. Let&apos;s grow your brand with AI.
                                        </h6>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="row g-2">
                                <div className="col-lg-7 col-md-8 col-12">
                                    <h6 className="reveal-text neutral-800 mb-60">
                                        <RevealText>
                                            ADS AI combines artificial intelligence, data insights, and creative strategy to build campaigns that reach the right audience, generate quality leads, and improve advertising performance.
                                        </RevealText>
                                    </h6>
                                </div>
                                        ...
                                        <div className="bg-neutral-0 rounded-4 p-5 mt-2">
                                            ...
                                            <div className="pt-150">
                                                ...
                                                <p className="fz-font-lg mt-3 mb-0">
                                                    We create AI-powered campaigns focused on visibility, engagement, lead generation, and business growth.
                                                </p>
                                            </div>
                                        </div>
                                    </div>
