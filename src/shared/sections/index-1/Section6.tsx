...
const TESTIMONIAL_SOURCES = [
    {
        ...
        comment:
            "ADS AI helped us reach the right audience with smarter campaigns. Our leads improved and the ad performance became much stronger.",
    },
    {
        starColor: "#585959",
        ...
        comment:
            "Their AI advertising strategy saved time, reduced wasted budget, and brought us better quality inquiries for our business.",
    },
    {
        starColor: "#FFB618",
        ...
        comment:
            "ADS AI created powerful ad creatives and optimized our campaigns with clear data insights. The results were professional and measurable.",
    },
];
