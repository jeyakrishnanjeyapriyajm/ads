...
const TEAM_MEMBERS = [
    { linkPost: "/team-details", img: "/assets/imgs/pages/img-17.webp", name: "AI Strategist", position: "Campaign Planning" },
    { linkPost: "/team-details", img: "/assets/imgs/pages/img-18.webp", name: "Ad Specialist", position: "Performance Ads" },
    { linkPost: "/team-details", img: "/assets/imgs/pages/img-19.webp", name: "Creative Lead", position: "AI Content Creation" },
    { linkPost: "/team-details", img: "/assets/imgs/pages/img-20.webp", name: "Data Analyst", position: "Campaign Optimization" },
];
                        ...
                        <div className="col-xxl-7 col-lg-8">
                            <div className="at-about-title-wrap mb-30">
                                ...
                                <h3 className="at-section-title reveal-text mb-lg-0 mb-4">
                                    <RevealText>
                                         Meet the AI advertising experts behind ADS AI. We combine strategy, creativity, automation, and data insights to help brands grow faster.
                                    </RevealText>
                                </h3>
                                <div
