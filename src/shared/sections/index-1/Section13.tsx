...
const BLOG_ITEMS = [
    {
        ...
        img: "/assets/imgs/images/img-35.jpg",
        title: "How AI Advertising Helps Brands Reach the Right Audience",
        author: "ADS AI",
        date: "July 3, 2026",
    },
    {
        ...
        linkPost: "/blog-details",
        linkAuthor: "/team-details",
        img: "/assets/imgs/images/img-33.jpg",
        title: "Why Smart Targeting Improves Campaign Performance",
        author: "ADS AI",
        date: "July 8, 2026",
    },
    {
        ...
        linkPost: "/blog-details",
        linkAuthor: "/team-details",
        img: "/assets/imgs/images/img-31.jpg",
        title: "Using AI Creatives to Generate Better Leads Online",
        author: "ADS AI",
        date: "July 12, 2026",
    },
    {
        ...
        title: "How Marketing Automation Saves Time and Increases Growth",
        author: "ADS AI",
        date: "July 17, 2026",
    },
];
                ...
                <div className="row align-items-end mb-50">
                    <div className="col-lg-8 col-xxl-6">
                        ...
                        <h3 className="alt-section-title lh-1 neutral-900 fw-700 mb-30 reveal-text mb-0">
                            <RevealText>
                                 Latest Insights From Our <br />AI Advertising Blog
                            </RevealText>
                        </h3>
                    </div>
                    <div className="col-xxl-2 col-lg-3 ms-auto text-xxl-end text-lg-end">
                        <div className="at-service-btn pt-30">
                            <Link className="at-btn" to="/archive">
                                <span>
                                    <span className="text-1">ALL INSIGHTS</span>
                                    <span className="text-2">ALL INSIGHTS</span>
                                </span>
                                <i>
                                    {ARROW_SVG}
                                    {ARROW_SVG}
