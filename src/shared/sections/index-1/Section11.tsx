...
const FAQ_ITEMS = [
    {
        id: "collapseOne",
        num: "1",
        question: "How can ADS AI help my business grow?",
        answer: "ADS AI helps your business grow by creating AI-powered ad campaigns that reach the right audience, generate quality leads, and improve conversions.",
        open: true,
    },
    {
        id: "collapseTwo",
        num: "2",
        question: "What type of advertising campaigns do you create?",
        answer: "We create social media ads, lead generation campaigns, brand awareness campaigns, performance ads, and AI-powered creative campaigns.",
        open: false,
    },
    {
        id: "collapseThree",
        ...
        answer: "Yes, we work with startups, small businesses, and growing brands by creating advertising strategies that match their goals and budget.",
        open: false,
    },
    {
        id: "collapseFour",
        num: "4",
        question: "Can you manage and optimize our ad campaigns?",
        answer: "Yes, we monitor campaign performance, analyze data, improve targeting, test creatives, and optimize ads for better results.",
        open: false,
    },
];
                    ...
                    <div className="col-lg-5">
                        <div className="alt-faq-title-wrap mb-40">
                            <div className="rounded-4 overflow-hidden anim-zoomin">
                                <img
                                    src="/assets/imgs/images/img-19.jpg"
                                    width={600}
                                    height={700}
                                    className="w-100"
                            ...
                            <p className="at-faq-dec mb-35">Tell us your goal and ADS AI will guide your campaign strategy.</p>
                            <div
                    ...
                    <div className="col-lg-7">
                        <div className="at-faq ml-115">
                            ...
                            <h3 className="at-section-title reveal-text">
                                <RevealText>
                                    Common questions about AI advertising, campaign growth, and how ADS AI works.
                                </RevealText>
                            </h3>
