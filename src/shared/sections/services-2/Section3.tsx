...
const FAQ_ITEMS = [
    {
        id: "collapseOne",
        num: "1",
        question: "What type of AI video services do you offer?",
        answer: "We create AI ad films, AI films, AI voice overs, promotional videos, corporate films, product explainers, documentary videos, and social media video ads for digital, TV, and OTT platforms.",
        open: true,
    },
    {
        id: "collapseTwo",
        num: "2",
        question: "How does your AI video production process work?",
        answer: "Our process includes discovery, strategy, creative concept, pre-production, AI-assisted production, post-production, and final delivery in platform-ready formats.",
        open: false,
    },
    {
        id: "collapseThree",
        num: "3",
        question: "Can you create videos for social media advertising?",
        answer: "Yes. We create short-form and performance-focused video ads optimized for Instagram, Facebook, YouTube, LinkedIn, reels, shorts, stories, and paid campaigns.",
        open: false,
    },
    {
        id: "collapseFour",
        ...
        answer: "Yes. AdsAI manages everything from strategy, scripting, AI visualization, voice overs, editing, sound design, and final export to campaign-ready delivery.",
        open: false,
    },
];
