...
const TEAM = [
    {
        classList: "col-lg-3 col-md-6 pt-md-5",
        linkPost: "/team-details",
        img: "/assets/imgs/images/img-110.jpg",
        name: "Creative Strategy Team",
        position: "Brand Strategy & Campaign Planning",
    },
    {
        classList: "col-lg-3 col-md-6",
        linkPost: "/team-details",
        img: "/assets/imgs/images/img-111.jpg",
        name: "AI Production Team",
        position: "AI Visuals & Motion Design",
    },
    {
        classList: "col-lg-3 col-md-6 pt-md-5",
        linkPost: "/team-details",
        img: "/assets/imgs/images/img-112.jpg",
        name: "Post-Production Team",
        position: "Editing, Sound & Final Polish",
    },
    {
        classList: "col-lg-3 col-md-6",
        linkPost: "/team-details",
        img: "/assets/imgs/images/img-113.jpg",
        name: "Client Success Team",
        position: "Delivery & Campaign Support",
    },
];
                    ...
                    <div className="row align-items-center">
                        ...
                        <div className="col-lg-5 h-100">
                            <h1 className="section-title fw-500 fz-ds-1 lh-1 reveal-text">
                                <RevealText>The Minds Behind AdsAI</RevealText>
                            </h1>
                        </div>

                        <div className="col-lg-5 ms-auto">
                            <p className="fz-font-3xl mb-4">
                                A team of strategists, AI creators, visual storytellers, editors, and campaign thinkers
                                working together to create video content that attracts, engages, and converts.
                            </p>
