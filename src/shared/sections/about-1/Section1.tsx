...
const AVATARS = [
    { src: "/assets/imgs/images/img-51.jpg", alt: "ADS AI Client", hiddenOnMobile: false },
    { src: "/assets/imgs/images/img-56.jpg", alt: "ADS AI Client", hiddenOnMobile: false },
    { src: "/assets/imgs/images/img-61.jpg", alt: "ADS AI Client", hiddenOnMobile: false },
    { src: "/assets/imgs/images/img-66.jpg", alt: "ADS AI Client", hiddenOnMobile: false },
    { src: "/assets/imgs/images/img-70.jpg", alt: "ADS AI Client", hiddenOnMobile: true },
];
                ...
                <div className="row align-items-center g-4">
                    ...
                    <div className="col-lg-7 h-100">
                        <h2 className="section-title fw-600 lh-1 reveal-text">
                              <RevealText>
                                Content that converts requires time, skill and resources we handle it all for you
                            </RevealText>
                        </h2>
                    </div>
                    <div className="col-lg-5 ms-auto">
                         <h6 className="mb-4 fw-600">
                            AdsAI creates performance-focused AI ad films, promotional videos, voice overs,
                            corporate films, and social media ads that help brands communicate clearly,
                            attract attention, and grow faster across digital platforms.
                        </h6>
