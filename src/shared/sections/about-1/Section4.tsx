...
const OFFICES = [
        ...
        icon: OFFICE_ICON_1,
        title: "Email",
        address: "business@adsai.ai",
        city: "",
        phone: "+91 91331 87000",
        phoneHref: "tel:+919133187000",
        email: "business@adsai.ai",
        emailHref: "mailto:business@adsai.ai",
    },
    {
        icon: OFFICE_ICON_2,
        title: "Office",
        address: "Hollywood Digital VFX Studios Pvt. Ltd.",
        city: "2nd Floor, Plot A-11, Moula Ali Industrial Area, Near Rotomaker, Hyderabad, Telangana – 500040, India",
        phone: "+91 90522 04000",
        phoneHref: "tel:+919052204000",
        email: "business@adsai.ai",
        emailHref: "mailto:business@adsai.ai",
    },
];
                ...
                <div className="row g-4 align-items-end mb-50">
                    <div className="col-lg-6">
                        ...
                        <h1 className="alt-section-title fz-ds-1 lh-1 fw-500 mb-30 reveal-text mb-0">
                              <RevealText>Let&apos;s Create Something Epic</RevealText>
                        </h1>
                    </div>
                    <div className="col-xxl-4 col-lg-6 col-md-8 ms-lg-auto text-lg-end">
                       ...
                       <p className="fz-font-lg pt-lg-4 mb-0">
                            Ready to transform your brand with AI-powered video? <br />
