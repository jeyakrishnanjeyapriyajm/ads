...
const RELATED_PROJECTS: RelatedCard[] = [
    {
        ...
        alt: "ADS AI ad film",
        tag: "AI Ad Film",
        title: "Cinematic AI ad films built for attention",
        description: "Premium AI-powered video content designed to help brands communicate clearly and convert faster.",
        projectName: "AI Ad Film",
        contentMt15: true,
    },
    {
        img: "/assets/imgs/images/img-62.jpg",
        alt: "ADS AI promotional video",
        tag: "Promotional Video",
        title: "High-impact videos for brand campaigns",
        description: "Creative promotional videos made for Meta, YouTube, Instagram, and performance advertising.",
        projectName: "Promotional Video",
        contentMt15: true,
    },
    {
        img: "/assets/imgs/images/img-68.jpg",
        alt: "ADS AI product explainer",
        tag: "Product Explainer",
        title: "Clear product stories powered by AI",
        description: "AI-generated visuals, voice overs, and editing that explain products in a simple and engaging way.",
        projectName: "Product Explainer",
        contentMt15: false,
    },
];
